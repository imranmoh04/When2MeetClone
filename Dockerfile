# Author  : Mohid Imran <imranmoh@msu.edu>
# Access instance using `docker exec -it _flask-app bash`

# Instantiate Ubuntu 20.04
FROM ubuntu:20.04
LABEL maintainer "Mohid Imran <imranmoh@msu.edu>"
LABEL description="This is custom Docker Image for Mohid Imran's Final Exam"
